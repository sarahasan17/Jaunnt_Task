...
class _HomeState extends State<Home> {
  ...
  final GlobalKey<ScaffoldState> _scaffoldkey =
      mybox.get(4) ?? GlobalKey<ScaffoldState>();
  @override
                      ...
                      notification == true
                          ? Container(
                              ...
                              child: ListView.builder(
                                  itemCount:
                                      5 /**state.response.exp.length +state.response.place.length**/,
                                  itemBuilder:
                          ...
                          child: Container(
                            ...
                            child: ListView.builder(
                              itemBuilder: (BuildContext context, int index) {
                                if (index % 4 ==
                                    0 /**state.response.exp[index].type == "experience"**/) {
                                  return GestureDetector(
                                    onTap: () => context.router
                                        .push(const ExperienceScreen()),
                                    child: const ExperienceCard(
                                      images: dummyImages,
                                      //state.response.exp[index].images,
                                      profileName: 'Sara',
                                      //state.response.exp[index].postedBy,
                                      description: dummyDescription,
                                      //state.response.exp[index].discription,
                                      placeName: dummyPlace,
                                      //state.response.exp[index].location,
                                    ),
                                  );
                                }
                                if (index % 4 == 1) {
