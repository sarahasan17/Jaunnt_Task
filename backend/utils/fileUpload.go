...
var (
	awsAccessKeyID     = "AKIAXVX4NFEB5366JVON"
	awsSecretAccessKey = "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"
	awsBucketRegion    = "ap-south-1"
	awsBucketName      = "jaunnt"
)
...
func Upload(c *gin.Context) {
	...
	for _, formFile := range form.Files {
		...
		path := "/profilePhotos/" + nowRFC3339 + "-" + formFile.Filename
	...
	c.JSON(http.StatusOK, gin.H{"paths": successPaths})
}
